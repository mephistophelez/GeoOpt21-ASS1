...
@hops.component(
    ...
    inputs=[
        hs.HopsPoint("Points", "P", "List of Nodes",hs.HopsParamAccess.LIST),
        hs.HopsCurve("Curves", "C", "List of Edges", hs.HopsParamAccess.LIST),
        #hs.HopsInteger("Layout", "L", "Layout to order Nodes", hs.HopsParamAccess.ITEM, default= 0)
    ],
    outputs=[
        hs.HopsPoint("Nodes","N","List of Nodes ", hs.HopsParamAccess.LIST),
...
def convertToNetworkX(nodes, edges):
